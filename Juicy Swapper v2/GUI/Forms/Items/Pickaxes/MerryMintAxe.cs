...
namespace Juicy_Swapper_v2.GUI.Forms.Items.Pickaxes
{
    public partial class MerryMintAxe : Form
    {
        ...
        {
            itemDialogPictureBox.Image = Resources.MerryMintAxeIcon;
        }
        ...
        private void swapBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    JuicyUtilities.RemoveCustomPak("26", itemDialogTextBox, swapBtn);
                    Settings.Default.merryMintAxeEnabled = false;
                }
